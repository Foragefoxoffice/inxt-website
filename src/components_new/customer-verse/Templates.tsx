              ...
              <div className="space-y-3 sm:space-y-4 text-center">
                <RevealAnimation delay={0.2}>
                  <h2 id="templates-heading" className="mx-auto text-center lg:max-w-[818px]">
                    Experience CustomerVerse in Action
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto text-center lg:max-w-[450px]">
                    Explore the powerful tools and digital capabilities that help businesses create seamless customer experiences across every touchpoint.
                  </p>
                </RevealAnimation>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="relative z-20 mt-28 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[320px]">
                      Capture and manage centralized customer profiles with interaction and engagement history.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-[41px] z-20 mt-8 space-y-1 sm:mt-13.5">
                    ...
                    <p className="max-w-[350px]">Digitize onboarding with automated verification and document processing.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative z-20 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[400px]">
                      Track engagement metrics, interactions, and service performance in real time.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.2}>
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[300px]">Enable seamless messaging and communication across multiple channels.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[500px]">Access a unified view of customer activities, preferences, and service history.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.4} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[320px]">
                      Generate insights and reports to optimize customer engagement strategies.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
