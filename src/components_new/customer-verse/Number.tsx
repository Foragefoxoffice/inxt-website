          ...
          <div className="space-y-5 text-center xl:max-w-[442px] xl:text-left">
            ...
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Driving Measurable Customer Engagement Results</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="max-w-[780px]">
                  CustomerVerse empowers organizations to strengthen customer relationships and deliver personalized experiences through data-driven engagement strategies.
                </p>
              </RevealAnimation>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row">
            ...
            <RevealAnimation delay={0.4} direction="up">
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Customer Engagement Improvement</h3>
            ...
            <RevealAnimation delay={0.5}>
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8">
                {/* card heading    */}
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Customer Retention Increase</h3>
