            ...
            <RevealAnimation delay={0.1}>
              <h1 className="mb-3 font-medium opacity-0 leading-[1.2]">
                <span className="hero-text-gradient hero-text-color-2 block">
                  CustomerVerse <br className="hidden md:block" /> AI-Powered Customer Engagement Platform
                </span>
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="mx-auto mb-7 max-w-[750px] md:mb-14">
                CustomerVerse is a direct-to-customer engagement platform designed to deliver personalized, omnichannel experiences across the entire customer journey.
                <br /><br />
                By leveraging real-time data, AI-driven insights, and intelligent automation, CustomerVerse empowers businesses to connect with customers more meaningfully—enhancing satisfaction, improving retention, and accelerating digital-first growth.
              </p>
            </RevealAnimation>
