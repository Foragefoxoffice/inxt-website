              ...
              <div className="w-full space-y-7 text-center md:text-left lg:max-w-[490px] lg:space-y-14 xl:max-w-[629px]">
                ...
                <div className="space-y-4">
                  <RevealAnimation delay={0.2}>
                    <h1>End-to-End Customer Lifecycle Management</h1>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p>
                      CustomerVerse enables organizations to manage the complete customer lifecycle—from onboarding and engagement to service interactions and retention.
                      <br /><br />
                      The platform unifies customer data, communication channels, engagement workflows, and analytics into a single intelligent ecosystem, helping businesses deliver consistent experiences and build long-term customer relationships.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
