          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Customer Engagement Experience
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Deliver personalized, seamless customer experiences with an intelligent platform designed to modernize engagement and strengthen long-term customer relationships.</p>
            </RevealAnimation>
          </div>
        </div>
