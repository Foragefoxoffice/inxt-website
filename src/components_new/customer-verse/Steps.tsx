...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect with enterprise systems to synchronize customer data and operational workflows.',
    image: Step1,
  },
  {
    id: '2',
    title: 'CRM & Customer Platforms',
    description: 'Integrate with CRM systems to manage customer interactions and engagement activities.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    ...
    description: 'Leverage analytics platforms to gain insights into customer behavior and engagement performance.',
    image: Step3,
  },
];
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Seamless Customer Experiences</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>CustomerVerse integrates with core business systems, communication platforms, and analytics tools to create a unified digital experience across all customer touchpoints.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
