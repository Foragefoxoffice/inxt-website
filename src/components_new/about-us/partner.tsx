            ...
            <div className="relative z-0 mx-5 mb-[70px] max-w-[900px] text-center sm:mx-auto">
              ...
              <RevealAnimation delay={0.3}>
                <h2 className="mb-3 text-white">
                  ...
                  <span className="text-primary-500"> Insurance Modernization </span>
                </h2>
              </RevealAnimation>
              <RevealAnimation delay={0.4}>
                <p className="text-accent/60 mb-6">
                  At Iorta TechNXT, we don't just deliver technology we deliver impact. Whether you're looking to optimize operations, reduce time-to-market, or improve customer engagement, we help you stay ahead in a rapidly evolving insurance landscape.
                </p>
              </RevealAnimation>
              <RevealAnimation delay={0.5}>
                <p className="text-white text-heading-5">Let's redefine insurance. Together.</p>
              </RevealAnimation>
            </div>
