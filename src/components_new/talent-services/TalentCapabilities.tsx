...
const data = [
  { id: 1, title: 'Talent acquisition strategy' },
  { id: 2, title: 'Role definition and workforce planning' },
  { id: 3, title: 'Candidate sourcing and talent mapping' },
  { id: 4, title: 'Technical and domain-specific hiring' },
  { id: 5, title: 'Executive and leadership recruitment' },
  { id: 6, title: 'Candidate screening and evaluation' },
  { id: 7, title: 'Interview coordination and selection support' },
  { id: 8, title: 'Employee onboarding frameworks' },
  { id: 9, title: 'Workforce scalability planning' },
  { id: 10, title: 'Long-term talent partnership' },
];
      ...
      <div className="main-container">
        <div className="mb-10 space-y-5 text-center md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <span className="badge bg-[#D3E7F8]">Talent Expertise</span>
          </RevealAnimation>
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>
                Comprehensive Recruitment & <br className="hidden md:block" /> HR Capabilities
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mx-auto max-w-[500px] lg:max-w-[674px]">
                Our recruitment services help BFSI organizations attract, evaluate, and retain high-quality talent to support long-term business success.
              </p>
            </RevealAnimation>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-y-6 lg:flex-row lg:gap-8 xl:gap-12">
            <RevealAnimation delay={0.5} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">Talent Strategy & Acquisition</h3>
                <ul>
            ...
            <RevealAnimation delay={0.7} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">HR & Workforce Support</h3>
                <ul>
...
TalentCapabilities.displayName = 'TalentCapabilities';
