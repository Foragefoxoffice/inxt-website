        ...
        <div className="main-container relative z-20 flex flex-col items-center justify-center text-center">
          ...
          <RevealAnimation delay={0.2}>
            <h1 className="mx-auto my-12 max-w-[350px] leading-[1.2] sm:max-w-[450px] md:max-w-[700px] xl:max-w-[846px]">
              <span className="hero-text-gradient hero-text-color-1 block">
                Recruitment & HR Solutions <br className="hidden md:block" /> for the BFSI Sector
              </span>
            </h1>
          </RevealAnimation>
          ...
          <RevealAnimation delay={0.3}>
            <p className="mb-7 max-w-[700px] md:mb-10 lg:mb-14">
              Connect with the right talent and build high-performing teams through strategic recruitment and HR solutions designed specifically for the banking, financial services, and insurance industry.
            </p>
          </RevealAnimation>
          ...
          <ul className="opacity-0 hidden md:block mx-auto mb-9 flex flex-col gap-4 max-md:w-full md:mx-0 md:mb-11 md:w-auto md:flex-row lg:mb-14">
            <RevealAnimation delay={0.3} direction="left" offset={50}>
              <li>
                <LinkButton href="/login" className="btn btn-primary hover:btn-white-dark dark:hover:btn-white btn-lg md:btn-xl mx-auto w-full md:mx-0 md:w-auto">
                  Get started
                </LinkButton>
              </li>
            </RevealAnimation>
            <RevealAnimation delay={0.5} direction="left" offset={50}>
              <li>
                <LinkButton href="/signup" className="btn btn-white hover:btn-primary dark:btn-white-dark btn-lg md:btn-xl mx-auto w-full md:mx-0 md:w-auto">
                  Free trial
                </LinkButton>
              </li>
            </RevealAnimation>
...
TalentHero.displayName = 'TalentHero';
