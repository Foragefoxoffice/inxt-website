              ...
              <div className="space-y-3 sm:space-y-4 text-center">
                <RevealAnimation delay={0.2}>
                  <h2 id="templates-heading" className="mx-auto text-center lg:max-w-[818px]">
                    Experience BrokerVerse in Action
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto text-center lg:max-w-[450px]">
                    Explore the powerful tools and intuitive dashboards that help brokerages manage clients, policies, claims, and financial operations through a centralized platform.
                  </p>
                </RevealAnimation>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="relative z-20 mt-28 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[320px]">
                      Capture, organize, and manage broker client profiles with policy history and servicing details.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative h-[300px] w-full max-w-[549.58px] transition-all duration-500 ease-in-out group-hover:scale-105 sm:h-[412px]">
                    ...
                    <RevealAnimation delay={0.4} duration={2.5} direction="right" useSpring={true}>
                      <figure className="absolute top-[35%] right-[3%] w-full max-w-[251px] -rotate-6 overflow-hidden rounded-[11px]">
                        <Image
                          src={templateImg2V2}
                          alt="Customizable resume template with multiple fonts, colors, and background styles"
                          className="object-cover"
                    ...
                    <RevealAnimation delay={0.5} duration={2.5} direction="left" useSpring={true}>
                      <figure className="border-stroke-1 absolute top-1/2 left-[3%] z-[-1] w-full max-w-[251px] rotate-12 overflow-hidden rounded-[11px] border">
                        <Image
                          src={templateImg2V3}
                          alt="Customizable resume template with multiple fonts, colors, and background styles"
                          className="object-cover"
                  ...
                  <div className="absolute bottom-[41px] z-20 mt-8 space-y-1 sm:mt-13.5">
                    <h3 id="card2-heading" className="text-heading-5 max-w-[250px] text-[#0d0d12]/90">
                      Policy Placement Management
                    </h3>
                    <p className="max-w-[350px]">Manage policy issuance, endorsements, renewals, and insurer placements through a streamlined workflow.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative z-20 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[400px]">
                      Monitor broker productivity, policy performance, and revenue contributions with real-time insights.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.2}>
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[250px]">Digitize onboarding workflows, manage documents, and automate compliance processes.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[500px]">Access a unified view of client policies, claims history, communications, and financial activity.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    <h3 id="card6-heading" className="text-heading-5 max-w-[300px] text-[#0d0d12]/90">
                      Brokerage Analytics & Reports
                    </h3>
                    <p className="max-w-[320px]">
                      Generate detailed reports and insights to optimize broker performance and business growth.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
