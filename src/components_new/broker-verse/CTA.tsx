          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Insurance Brokerage Operations
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Empower your brokerage with a unified digital platform designed to manage clients, policies, and distribution networks efficiently with real-time insights.</p>
            </RevealAnimation>
          </div>
        </div>
