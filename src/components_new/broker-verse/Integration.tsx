...
const stackCards = [
  {
    icon: 'ns-shape-19',
    title: 'Broker Productivity Improvement',
    description: 'Higher broker efficiency',
  },
  {
    icon: 'ns-shape-35',
    title: 'Broker Performance Visibility',
    description: 'Real-time performance insights',
  },
  {
    icon: 'ns-shape-4',
    title: 'Client Onboarding Acceleration',
    description: 'Faster onboarding workflows',
  },
  {
    icon: 'ns-shape-21',
    title: 'Data-Driven Broker Decisions',
    description: 'Analytics-based strategy',
  },
  {
    icon: 'ns-shape-21',
    title: 'Distribution Network Scaling',
    description: 'Efficient broker network growth',
  }
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 whitespace-normal">
                Drive Broker Growth and Operational Efficiency
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                Improve brokerage productivity, streamline policy servicing, and strengthen client relationships with intelligent automation and real-time operational insights.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
