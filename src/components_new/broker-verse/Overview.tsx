              ...
              <div className="w-full space-y-7 text-center md:text-left lg:max-w-[490px] lg:space-y-14 xl:max-w-[629px]">
                ...
                <div className="space-y-4">
                  <RevealAnimation delay={0.2}>
                    <h1>End-to-End Brokerage Lifecycle Management</h1>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p>
                      BrokerVerse enables insurance brokers to manage the complete brokerage lifecycle — from client acquisition and policy placement to claims servicing and financial reconciliation.
                      <br /><br />
                      The platform unifies broker operations, accounting, workflows, and analytics into a single intelligent system, helping brokerages improve productivity, enhance client servicing, and scale their distribution networks efficiently.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
                ...
                <RevealAnimation delay={0.4}>
                  <figure className="absolute top-[117px] left-[-5px] z-1 max-w-[96px] overflow-hidden rounded-xl md:left-[23px] md:max-w-[119px] lg:top-2.5 lg:left-[-222px] lg:max-w-[104px] xl:top-6 xl:left-[-203px] xl:max-w-[119px] 2xl:top-2.5 2xl:-left-[132px]">
                    <div className="dark:bg-background-6 rounded-xl bg-white p-6">
                      <Image
                        className="inline-block size-14 h-auto rounded-full bg-linear-[156deg,#FFF_32.92%,#C6F56F_91%] sm:size-14"
                        src={avatar9}
                        alt="Avatar 1"
                      />
                    </div>
