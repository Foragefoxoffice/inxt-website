            ...
            <RevealAnimation delay={0.1}>
              <h1 className="mb-3 font-medium opacity-0 leading-[1.2]">
                <span className="hero-text-gradient hero-text-color-2 block">
                  BrokerVerse <br className="hidden md:block" /> AI-Powered Insurance Brokerage Management Platform
                </span>
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="mx-auto mb-7 max-w-[750px] md:mb-14">
                BrokerVerse is an end-to-end digital platform that empowers insurance brokers to manage clients, policies, claims, and financial operations from a single intelligent system.
                <br /><br />
                With AI-driven insights, automated workflows, and integrated broker network management, BrokerVerse helps brokerages streamline operations, strengthen client relationships, and scale their distribution networks efficiently.
              </p>
            </RevealAnimation>
