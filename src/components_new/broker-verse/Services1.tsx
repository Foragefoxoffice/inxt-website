...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Broker client lifecycle management and servicing',
  },
  {
    id: '2',
    text: 'Policy placement, endorsements, and renewals',
  },
  {
    id: '3',
    text: 'Client onboarding and documentation automation',
  },
  {
    id:'4',
    text:'Commission tracking and brokerage financial management'
  },
  {
    id:'5',
    text:'Broker performance analytics and operational reporting'
  }
];
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[620px]">
                      Applications of BrokerVerse
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>BrokerVerse empowers insurance brokers to streamline brokerage operations including client management, policy servicing, claims coordination, and financial workflows. The platform helps brokerages improve efficiency, strengthen client relationships, and scale distribution networks.</p>
                  </RevealAnimation>
                </div>
