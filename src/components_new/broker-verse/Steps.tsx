...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect seamlessly with policy administration systems to synchronize customer, policy, and broker operations data.',
    image: Step1,
  },
  {
    id: '2',
    title: 'Broker Accounting & Financial Systems',
    description: 'Integrate with financial and accounting platforms to manage commissions, premiums, and financial reconciliations.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    ...
    description: 'Link with analytics platforms to gain real-time operational insights and optimize brokerage performance.',
    image: Step3,
  },
];
...
const Steps = () => {
  return (
    <section
      className="bg-background-2 dark:bg-background-5 relative py-16 md:py-20 lg:pt-[100px] xl:pt-[200px] xl:pb-[100px]"
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Seamless Broker Operations</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>BrokerVerse integrates with core insurance systems, accounting platforms, and reporting tools to enable smooth data flow, improve operational efficiency, and support scalable brokerage operations.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
