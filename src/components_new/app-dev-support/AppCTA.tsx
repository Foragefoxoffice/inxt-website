          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Build Powerful Applications That Scale with Your Business
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">
                Partner with our development experts to create high-performance applications that drive innovation, improve efficiency, and support your digital transformation strategy.
              </p>
            </RevealAnimation>
          </div>
        </div>
