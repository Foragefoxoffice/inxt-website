...
const ServiceCard = ({ service, index }: ServiceCardProps) => {
  return (
    <div
      className={cn(
        'border-stroke-1 col-span-12 flex w-full flex-col items-center gap-y-[22px] rounded-[20px] border px-8 py-10.5 md:col-span-4 md:max-w-[314px] md:items-start lg:col-span-3 min-h-[240px]',
