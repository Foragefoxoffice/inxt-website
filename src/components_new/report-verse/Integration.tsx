...
const stackCards = [
  {
    ...
    description: 'Unified analytics insights',
  },
  {
    icon: 'ns-shape-35',
    title: 'Faster Reporting Processes',
  ...
  },
  {
    ...
    description: 'Supports business growth',
  }
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 whitespace-normal">
                Unlock Data-Driven Business Growth
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                ReportVerse helps organizations make smarter decisions by transforming data into actionable insights and improving visibility into business performance.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
