...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect with ERP, CRM, and operational platforms to collect and analyze data.',
    image: Step1,
  },
  {
    id: '2',
    title: 'Data & Analytics Platforms',
    description: 'Integrate with data warehouses and analytics tools for advanced reporting.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    ...
    description: 'Leverage APIs to synchronize insights across digital systems and applications.',
    image: Step3,
  },
];
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Unified Analytics</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>ReportVerse integrates with enterprise systems, operational platforms, and analytics tools to create a unified data and reporting ecosystem.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
