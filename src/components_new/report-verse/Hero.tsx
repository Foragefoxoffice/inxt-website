            ...
            <RevealAnimation delay={0.1}>
              <h1 className="mb-3 font-medium opacity-0 leading-[1.2]">
                <span className="hero-text-gradient hero-text-color-2 block">
                  ReportVerse <br className="hidden md:block" /> AI-Powered Analytics & <br className="hidden md:block" /> Reporting Platform
                </span>
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="mx-auto mb-7 max-w-[750px] md:mb-14">
                ReportVerse is an intelligent analytics and reporting platform designed to transform business data into actionable insights. It enables organizations to monitor performance, generate real-time reports, and make informed decisions across operations. With advanced analytics, automated reporting workflows, and interactive dashboards, ReportVerse helps businesses gain deeper visibility into operations and drive data-driven growth.
              </p>
            </RevealAnimation>
