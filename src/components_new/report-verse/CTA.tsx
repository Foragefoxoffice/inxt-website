          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Business Insights with Data
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Empower your organization with intelligent analytics and reporting tools designed to turn data into meaningful insights.</p>
            </RevealAnimation>
          </div>
        </div>
