...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Business performance monitoring and KPI tracking',
  },
  {
    id: '2',
    text: 'Financial and operational reporting automation',
  },
  {
    id: '3',
    text: 'Data analysis and visualization across departments',
  },
  {
    id:'4',
    text:'Predictive analytics and trend forecasting'
  },
  {
    id:'5',
    text:'Business intelligence reporting for leadership insights'
  }
];
              ...
              <div>
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <span className="badge bg-[#E9F3FC] capitalize">Real-World</span>
                  </RevealAnimation>
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[620px]">
                      Applications of ReportVerse
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>ReportVerse empowers organizations to leverage analytics and reporting capabilities to monitor operations, analyze trends, and improve strategic decision-making.</p>
                  </RevealAnimation>
                </div>
