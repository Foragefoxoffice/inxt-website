              ...
              <div className="w-full space-y-7 text-center md:text-left lg:max-w-[490px] lg:space-y-14 xl:max-w-[629px]">
                ...
                <div className="space-y-4">
                  <RevealAnimation delay={0.2}>
                    <h1>End-to-End Business Intelligence & Reporting</h1>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p>
                      ReportVerse enables organizations to consolidate data from multiple systems and transform it into meaningful insights through automated reports, visual dashboards, and advanced analytics. The platform centralizes data analysis, reporting workflows, and performance monitoring, helping businesses improve decision-making and operational transparency.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
