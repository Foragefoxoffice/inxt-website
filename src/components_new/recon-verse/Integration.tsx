...
const stackCards = [
  ...
  {
    icon: 'ns-shape-35',
    title: 'Financial Accuracy Improvement',
    description: 'Minimized reconciliation errors',
  },
  {
    icon: 'ns-shape-4',
    title: 'Transaction Visibility',
    description: 'Real-time reconciliation insights',
  },
  {
    icon: 'ns-shape-21',
    title: 'Data-Driven Financial Decisions',
    description: 'Advanced reconciliation analytics',
  },
  {
    icon: 'ns-shape-21',
    title: 'Operational Efficiency Growth',
    description: 'Streamlined financial workflows',
  }
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                ReconVerse helps organizations automate reconciliation workflows, reduce financial errors, and gain real-time visibility into financial transactions.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
