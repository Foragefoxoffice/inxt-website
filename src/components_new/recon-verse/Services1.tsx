...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Payment reconciliation across banking and payment systems',
  },
  {
    id: '2',
    text: 'Financial transaction matching and validation',
  },
  {
    id: '3',
    text: 'Exception handling and reconciliation workflow management',
  },
  {
    id: '4',
    text: 'Financial reporting and reconciliation analytics',
  },
  {
    id: '5',
    text: 'Enterprise financial reconciliation automation',
  }
];
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[620px]">
                      Applications of ReconVerse
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>ReconVerse enables financial institutions and enterprises to streamline reconciliation workflows and maintain accurate financial records.</p>
                  </RevealAnimation>
                </div>
