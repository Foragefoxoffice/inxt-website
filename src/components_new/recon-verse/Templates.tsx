              ...
              <div className="space-y-3 sm:space-y-4 text-center">
                <RevealAnimation delay={0.2}>
                  <h2 id="templates-heading" className="mx-auto text-center lg:max-w-[818px]">
                    Experience ReconVerse in Action
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto text-center lg:max-w-[450px]">
                    Explore the powerful tools that help organizations automate reconciliation workflows and improve financial accuracy.
                  </p>
                </RevealAnimation>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="relative z-20 mt-28 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[320px]">
                      Capture and manage transaction data from multiple financial systems.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-[41px] z-20 mt-8 space-y-1 sm:mt-13.5">
                    ...
                    <p className="max-w-[350px]">Automate reconciliation matching across payment, banking, and accounting platforms.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative z-20 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[400px]">
                      Identify and resolve mismatched transactions efficiently.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.2}>
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[250px]">Validate financial records and ensure transaction accuracy.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    <h3 id="card5-heading" className="text-heading-5 max-w-[300px] text-[#0d0d12]/90">
                      Transaction 360° Profile
                    </h3>
                    <p className="max-w-[500px]">View detailed transaction information including matching status and reconciliation history.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    <h3 id="card6-heading" className="text-heading-5 max-w-[300px] text-[#0d0d12]/90">
                      Reconciliation Analytics & Reports
                    </h3>
                    <p className="max-w-[320px]">
                      Generate reports and insights to monitor reconciliation performance.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
