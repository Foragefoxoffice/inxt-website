...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect with banking systems to synchronize transaction data and reconciliation workflows.',
    image: Step1,
  },
  {
    id: '2',
    title: 'Payment Platform Integration',
    description: 'Integrate with payment gateways and financial systems to reconcile transaction records.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    ...
    description: 'Leverage analytics platforms to gain insights into reconciliation performance and financial trends.',
    image: Step3,
  },
];
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Seamless Financial Operations</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>ReconVerse integrates with banking systems, payment gateways, and financial platforms to create a unified reconciliation ecosystem.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
