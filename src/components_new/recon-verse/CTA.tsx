          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Financial Reconciliation Processes
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Modernize your reconciliation workflows with an intelligent platform designed to automate financial matching and improve operational efficiency.</p>
            </RevealAnimation>
          </div>
        </div>
