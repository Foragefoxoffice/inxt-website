            ...
            <div className="space-y-3">
              ...
              <RevealAnimation delay={0.3}>
                <p className="max-w-[780px]">
                  DigitalOne empowers organizations to accelerate digital transformation and improve customer engagement through intelligent automation and analytics.
                </p>
              </RevealAnimation>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row">
            ...
            <RevealAnimation delay={0.4} direction="up">
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8 min-h-[280px]">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Decision Speed Improvement</h3>
            ...
            <RevealAnimation delay={0.5}>
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8 min-h-[280px]">
                {/* card heading    */}
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Customer Engagement Growth</h3>
