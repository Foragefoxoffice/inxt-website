...
const Overview = () => {
  return (
    <section className="overflow-hidden pt-[80px] pb-[15px]">
              ...
              <div className="w-full space-y-7 text-center md:text-left lg:max-w-[490px] lg:space-y-14 xl:max-w-[629px]">
                ...
                <div className="space-y-4">
                  <RevealAnimation delay={0.2}>
                    <h1>AI-Powered Digital Experiences for Enterprises</h1>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p>
                      DigitalOne enables organizations to design and manage modern digital experiences from a single platform. By connecting customer engagement tools, real-time analytics, and workflow automation, businesses can deliver consistent digital services across every touchpoint.
                    </p>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
                      With intelligent insights and scalable architecture, DigitalOne helps enterprises improve customer interactions, streamline service delivery, and unlock new digital growth opportunities.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
