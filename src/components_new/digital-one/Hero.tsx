            ...
            <RevealAnimation delay={0.2}>
              <h1 className="mx-auto max-w-[400px] leading-[1.3] sm:max-w-[600px] md:max-w-[900px] xl:max-w-[1110px]">
                <span className="hero-text-gradient hero-text-color-2 block">
                  DigitalOne <br className="hidden md:block" /> AI-Powered Digital Experience Platform
                </span>
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[400px] md:max-w-[600px] lg:max-w-full">
                DigitalOne is a unified digital experience platform designed to help organizations deliver seamless, personalized, and intelligent digital services across web, mobile, and connected channels. By combining real-time customer data, AI-driven insights, and automated digital workflows, DigitalOne empowers enterprises to build engaging digital journeys that improve customer satisfaction, strengthen loyalty, and accelerate digital transformation.
              </p>
            </RevealAnimation>
          </div>
        </div>
