...
const services = [
  {
    ...
    description: 'Analyze engagement patterns and predict customer behavior.',
    icon: 'ns-shape-33',
    image: serviceImage1,
    imageDark: serviceImageDark1,
    imgAlt: 'Machine Learning representation',
  },
  {
    slug: 'behavior-analytics',
    title: 'Customer Behavior Analytics',
    description: 'Track and analyze digital interactions across channels.',
    icon: 'ns-shape-34',
    image: serviceImage2,
    imageDark: serviceImageDark2,
    imgAlt: 'Behavior Analytics workflow',
  },
  {
    slug: 'nlp',
    title: 'Natural Language Processing',
    description: 'Enable conversational interfaces and digital assistants.',
    icon: 'ns-shape-35',
    image: serviceImage3,
    imageDark: serviceImageDark3,
    imgAlt: 'NLP interface',
  },
  {
    slug: 'real-time-data',
    title: 'Real-Time Data Processing',
    description: 'Process digital interaction data instantly to deliver dynamic experiences.',
    icon: 'ns-shape-36',
    image: serviceImage4,
    imageDark: serviceImageDark4,
    imgAlt: 'Real-Time Data Processing interface',
  },
  {
    slug: 'recommendation-engines',
    title: 'AI Recommendation Engines',
    description: 'Provide personalized recommendations based on user behavior.',
    icon: 'ns-shape-37',
    image: serviceImage5,
    imageDark: serviceImageDark5,
    imgAlt: 'Recommendation Engine interface',
  },
  {
    slug: 'data-visualization',
    title: 'Advanced Data Visualization',
    description: 'Transform complex engagement data into interactive dashboards.',
    icon: 'ns-shape-38',
    image: serviceImage1,
    imageDark: serviceImageDark1,
    imgAlt: 'Data Visualization interface',
  },
];
      ...
      <div className="main-container">
        <div className="mb-14 space-y-3 text-center md:mb-[70px]">
          ...
          <RevealAnimation delay={0.4}>
            <h2>
              Advanced AI Technologies Behind DigitalOne
            </h2>
          </RevealAnimation>
          <RevealAnimation delay={0.5}>
            <p className="mx-auto lg:max-w-[650px]">
              DigitalOne leverages advanced artificial intelligence and data technologies to power intelligent digital engagement and customer experience optimization.
            </p>
          </RevealAnimation>
        </div>
        {/* services */}
