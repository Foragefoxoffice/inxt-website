...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Digital customer onboarding and engagement platforms',
  },
  {
    id: '2',
    text: 'Unified service portals for customers and partners',
  },
  {
    id: '3',
    text: 'Personalized digital experiences across web and mobile',
  },
  {
    id: '4',
    text: 'Customer journey analytics and engagement monitoring',
  },
  {
    id: '5',
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[520px]">
                      Applications of DigitalOne
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>DigitalOne enables organizations to modernize customer engagement and digital service delivery across industries.</p>
                  </RevealAnimation>
                </div>
