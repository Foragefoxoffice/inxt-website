...
const services = [
  {
    ...
    description: 'Digitize and automate the claims lifecycle to accelerate claim processing and improve operational efficiency.',
    icon: 'ns-shape-32',
    image: '/images/ns-img-10.svg',
    imageDark: '/images/ns-img-dark-6.svg',
    slug: 'automated-claims',
    imgAlt: 'Automated claims workflows',
  },
  {
    id: 2,
    title: 'AI-Driven Underwriting Support',
    description: 'Leverage AI and analytics to enhance risk assessment and support faster underwriting decisions.',
    icon: 'ns-shape-20',
    image: '/images/ns-img-12.svg',
    imageDark: '/images/ns-img-12.svg',
    slug: 'underwriting-support',
    imgAlt: 'AI-driven underwriting support',
  },
  {
    id: 3,
    title: 'Policy Lifecycle Management',
    description: 'Manage the complete policy lifecycle including quoting, issuance, renewals, and servicing.',
    icon: 'ns-shape-10',
    image: '/images/ns-img-12.svg',
    imageDark: '/images/ns-img-12.svg',
    slug: 'policy-management',
    imgAlt: 'Policy lifecycle management',
  },
  {
    id: 4,
    title: 'Digital Customer Portals',
    description: 'Provide self-service digital platforms that enable customers to manage policies, claims, and service requests.',
    icon: 'ns-shape-15',
    image: '/images/ns-img-13.svg',
    imageDark: '/images/ns-img-13.svg',
    slug: 'customer-portals',
    imgAlt: 'Digital customer portals',
  },
  {
    id: 5,
    title: 'Real-Time Analytics & Reporting',
    description: 'Gain actionable insights through advanced analytics and real-time operational reporting.',
    icon: 'ns-shape-25',
    image: '/images/ns-img-13.svg',
    imageDark: '/images/ns-img-13.svg',
    slug: 'analytics-reporting',
    imgAlt: 'Real-time analytics and reporting',
  },
];
        ...
        <div className="mb-14 space-y-3 text-center md:mb-[70px]">
          ...
          <RevealAnimation delay={0.5}>
            <p className="mx-auto lg:max-w-[650px]">
             Our platforms enable insurers to streamline operations, automate core processes, and deliver seamless digital experiences for customers, agents, and partners.
        ...
        <div className="mb-10 grid grid-cols-12 gap-y-8 sm:gap-6 md:mb-14 md:gap-[42px]">
          ...
          {services.slice(0, 2).map((service, index) => (
            <RevealAnimation delay={0.6 + index * 0.1} key={service?.slug}>
              <div className="col-span-12 h-full sm:col-span-6 lg:col-span-6">
                <div className="dark:bg-background-6 flex h-full flex-col items-center gap-8 overflow-hidden rounded-[20px] bg-white px-5 py-8 md:flex-row md:px-8 lg:py-14">
          ...
          <RevealAnimation delay={0.8} key={services[2]?.slug}>
            <div className="col-span-12 h-full sm:col-span-6 md:col-span-6 lg:col-span-4">
                ...
                <div className="w-full">
                  ...
                  <div className="mt-8 mb-8 flex flex-col space-y-3 md:mt-12 md:mb-14">
                    ...
                    <p className="text-tagline-2">
                      <span className="text-secondary mb-1 block text-left text-xl leading-normal font-normal dark:text-white">
                        Trusted by 20k+
                      </span>
