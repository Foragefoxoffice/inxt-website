...
const managementData = [
  ...
  },
  {
    ...
    bio: [
      "Andrew Arokiaraj R is the Chief Solution Director at Iorta TechNXT, leading the technical architectural strategy and the delivery of complex insurance solutions. With a focus on performance and scalability, he ensures that our digital transformation initiatives meet the highest industry standards.",
      "He specializes in designing modular, API-first architectures that allow insurers to integrate seamlessly with various ecosystems. His commitment to technical excellence and innovation is a key driver in TechNXT's ability to deliver rapid, high-impact solutions."
    ]
  },
  {
    id: 4,
    ...
    bio: [
      "Giri Mohana Krishnan Natarajan serves as the Chief Delivery Director at Iorta TechNXT, overseeing the execution and successful rollout of digital platforms across global markets. He ensures that projects are delivered on time, within scope, and aligned with client expectations.",
      "With extensive experience in project management and operational efficiency, Giri leads our delivery teams with a focus on quality and consistency. His strategic oversight ensures that TechNXT remains a reliable partner for insurers undergoing large-scale modernization."
    ]
  },
  {
    id: 5,
    ...
    bio: [
      "Senthil Kumar leads the engineering excellence at Iorta TechNXT, focusing on building resilient and high-performance insurance systems. With deep expertise in cloud-native technologies, he ensures our platforms are future-ready.",
      "He is responsible for the technical roadmap and the implementation of advanced security protocols across our global deployments."
    ]
  },
  {
    id: 6,
    ...
    bio: [
      "Priya Sharma drives the product vision at Iorta TechNXT, bridging the gap between insurance business needs and technical possibilities. She focuses on user-centric design and agile product development.",
      "Her leadership ensures that our low-code platforms remain intuitive and powerful for insurers worldwide."
    ]
  },
  {
    id: 7,
    ...
    bio: [
      "Rajesh Varma leads our strategic expansion in the African market. With over 15 years in regional insurance markets, he understands the unique challenges and opportunities for digital transformation in emerging markets.",
      "He works closely with local insurers to implement TechNXT solutions that drive financial inclusion and operational efficiency."
    ]
  }
];
...
const ManagementTeam = () => {
  ...
  return (
    <section className="bg-white dark:bg-background-7 py-16 md:py-24 lg:py-32 overflow-hidden">
              ...
              <SwiperSlide key={member.id}>
                <button
                  ...
                  className={cn(
                    ...
                    selectedId === member.id ? "scale-105" : "opacity-60 hover:opacity-100"
                  )}
                >
                  <div className={cn(
                    "relative mx-auto size-24 md:size-32 lg:size-40 rounded-full overflow-hidden transition-all duration-300 ring-4",
                    selectedId === member.id 
                      ? "ring-primary-500 border-4 border-white dark:border-background-8 shadow-lg" 
