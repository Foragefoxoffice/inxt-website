...
const testimonialReviews: TestimonialReview[] = [
  {
    ...
    position: 'Founder and Group ',
    position2: 'CEO of Oona Insurance',
    image: avatar6,
    text: 'Our partnership with iorta TechNXTand the implementation of their insurance suite has enabled this multi-country launch and we will extend our innovative insurance products across Southeast Asia.',
  },
  {
    id: 2,
    name: 'Sarah Johnson',
                        ...
                        <blockquote className="space-y-3 md:space-y-6">
                          ...
                          <div className="space-y-3 md:space-y-4">
                            ...
                            <div>
                              ...
                              <p className="text-secondary/60 dark:text-accent/60 text-tagline-2">{review.position2}</p>
                            </div>
                          </div>
                        </blockquote>
                      </div>
