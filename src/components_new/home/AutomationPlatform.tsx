    ...
    <section className="py-18 md:py-20" aria-labelledby="automation-platform-heading">
      <div className="main-container">
        ...
        <RevealAnimation delay={0.7}>
          <div
            className="bg-background-4 mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-x-1 gap-y-4 rounded-4xl p-1 lg:flex-row lg:gap-y-0"
            ...
            {numberCards.map((card, index) => (
              <RevealAnimation key={card.number} delay={0.7 + index * 0.1}>
                <div className="w-full h-full space-y-2 rounded-[28px] bg-white p-8 md:p-[52px]">
