        ...
        <div className="flex flex-col items-center space-y-[40px] md:space-y-[50px] lg:space-y-[60px] xl:space-y-[70px]">
          <div className="mx-auto max-w-[628px] space-y-5 text-center">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-green mb-3 md:mb-4 lg:mb-5 capitalize">AI Intelligence</span>
            </RevealAnimation>
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>AI Solutions for Smarter Decisions</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p>AI-powered solutions designed to deliver intelligent insights, real-time decision support, and advanced analytics that help organizations operate more efficiently and make data-driven decisions.</p>
              </RevealAnimation>
            </div>
          </div>
          {/* cards  */}
          <div className="flex flex-col items-center justify-center gap-8 xl:flex-row">
            ...
            <RevealAnimation delay={0.4}>
              <article className="bg-background-3 dark:bg-background-5 relative h-[493px] w-full max-w-[408px] space-y-[72px] overflow-hidden rounded-[20px] px-0 pt-[29px] sm:px-2.5">
                ...
                <div className="mx-auto max-w-[350px] space-y-4 pl-4 text-center xl:text-left">
                  <h3 className="text-heading-5">DEX</h3>
                  <p>AI-driven decision intelligence solution that delivers real-time insights and nudges to trigger the right actions at the right moment, helping teams respond faster and operate more effectively.</p>
                </div>
                {/* card description   */}
            ...
            <RevealAnimation delay={0.5}>
              <article className="bg-[#3D5AF1] h-[493px] w-full max-w-[408px] space-y-[72px] overflow-hidden rounded-[20px] pt-[29px] sm:px-[29px]">
                {/* card heading  */}
                <div className="space-y-4 text-center xl:text-left">
                  <h3 className="text-white text-heading-5">Digital One</h3>
                  <p className="text-white/90">
                    Enterprise intelligence solution designed to enhance business performance using advanced analytics and AI-powered insights, enabling leadership teams to make smarter strategic decisions.
                  </p>
                </div>
                {/* card description   */}
                <RevealAnimation delay={0.5} offset={100}>
                  <div className="bg-secondary w-full space-y-9 rounded-2xl px-6 py-8">
                    ...
                    <div className="flex items-end gap-[30px] pb-[70px]">
                      <div className="bg-[#3D5AF1] h-[115px] w-4 rounded-t-4xl" />
                      <div className="bg-[#3D5AF1] h-[81px] w-4 rounded-t-4xl" />
                      <div className="bg-[#3D5AF1] h-[160px] w-4 rounded-t-4xl" />
                      <div className="bg-[#3D5AF1] h-[101px] w-4 rounded-t-4xl" />
                      <div className="bg-[#3D5AF1] h-[134px] w-4 rounded-t-4xl" />
                      <div className="bg-[#3D5AF1] h-[177px] w-4 rounded-t-4xl" />
            ...
            <RevealAnimation delay={0.6}>
              <article className="bg-background-3 dark:bg-background-5 relative h-[493px] w-full max-w-[408px] space-y-[72px] overflow-hidden rounded-[20px] px-0 pt-[29px] sm:px-2.5">
                {/* card heading  */}
                <div className="mx-auto max-w-[350px] space-y-4 pl-4 text-center xl:text-left">
                  <h3 className="text-heading-5">DASHES</h3>
                  <p>Executive dashboard solution that provides a unified and predictive view of business operations, delivering clear insights and performance monitoring across the organization.</p>
                </div>
                {/* card description   */}
