...
import clientLogo1 from '@public/images/ns-client-logo-1.svg';
import clientLogo2 from '@public/images/ns-client-logo-2.svg';
import clientLogo3 from '@public/images/ns-client-logo-3.svg';
import clientLogo4 from '@public/images/ns-client-logo-4.svg';
import clientLogo5 from '@public/images/ns-client-logo-5.svg';

import clientLogo1Dark from '@public/images/ns-client-logo-dark-1.svg';
import clientLogo2Dark from '@public/images/ns-client-logo-dark-2.svg';
import clientLogo3Dark from '@public/images/ns-client-logo-dark-3.svg';
import clientLogo4Dark from '@public/images/ns-client-logo-dark-4.svg';
import clientLogo5Dark from '@public/images/ns-client-logo-dark-5.svg';
      ...
      <section className="bg-background-3 dark:bg-background-5 relative overflow-hidden pt-[200px] pb-16 lg:pb-[100px] 2xl:pt-[250px]">
        ...
        <div className="main-container relative z-20 flex flex-col items-center text-center">
          ...
          <RevealAnimation delay={0.2} duration={2} useSpring={true}>
            <figure className="absolute hidden rotate-11 min-[1535px]:bottom-[18%]! min-[1535px]:-left-[5%]! min-[1735px]:bottom-[18%]! min-[1735px]:-left-[12.5%]! md:bottom-[67%] md:left-[1%] md:block md:w-[140px] lg:bottom-[52%] lg:left-[2%] lg:w-[180px] xl:bottom-[30%] xl:w-[250px] 2xl:w-[275px]">
              <Image
                src={heroAsset2}
                alt="Hero asset 2"
          ...
          <RevealAnimation instant delay={0.6}>
            <div className="relative mx-auto w-[375px] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1100px]">
              <div className="from-background-3 dark:from-background-5 absolute top-0 left-0 z-40 h-full w-[30%] bg-linear-to-r to-transparent"></div>
              <div className="from-background-3 dark:from-background-5 absolute top-0 right-0 z-40 h-full w-[30%] bg-linear-to-l to-transparent"></div>
              ...
              <Marquee autoFill speed={40}>
                <div className="flex items-center justify-center gap-8">
                  {[
                    ...
                    <figure key={index + 1} className={`w-28 md:w-36 ${index === 0 ? 'ml-8' : ''}`}>
                      <Image
                        src={logo.light}
