          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Merchant Onboarding Experience
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Empower your team with AI-powered merchant onboarding, automated compliance checks, and a unified platform designed for modern banking ecosystems.</p>
            </RevealAnimation>
          </div>
        </div>
