...
const stepsData: Step[] = [
  {
    id: '1',
    title: 'Core Banking & Payment Integration',
    description: 'Connect with banking systems and payment platforms to synchronize merchant transactions and onboarding data.',
    image: Step1,
  },
  {
    id: '2',
    title: 'CRM & Merchant Platforms',
    description: 'Integrate with CRM systems to manage merchant relationships and track onboarding interactions.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    id: '3',
    title: 'Analytics & Digital Banking Platforms',
    description: 'Leverage analytics and digital banking tools to gain insights into merchant performance and growth.',
    image: Step3,
  },
];
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Seamless Merchant Operations</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>MerchantVerse integrates with banking systems, payment platforms, and compliance systems to enable a fully connected merchant management ecosystem.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
