...
const stackCards = [
  {
    ...
    description: 'Accelerated merchant approval processes',
  },
  {
    icon: 'ns-shape-35',
    title: 'Merchant Performance Visibility',
    description: 'Real-time insights into merchant activity',
  },
  {
    icon: 'ns-shape-4',
    title: 'Compliance Process Automation',
    description: 'Streamlined regulatory verification workflows',
  },
  {
    icon: 'ns-shape-21',
    title: 'Data-Driven Merchant Decisions',
    description: 'Analytics-based merchant management',
  },
  {
    icon: 'ns-shape-21',
    title: 'Merchant Network Expansion',
    description: 'Efficient scaling of merchant ecosystems',
  }
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 whitespace-normal">
                Drive Merchant Growth and Operational Efficiency
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                MerchantVerse helps banks accelerate merchant onboarding, improve operational efficiency, and deliver seamless digital onboarding experiences.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
