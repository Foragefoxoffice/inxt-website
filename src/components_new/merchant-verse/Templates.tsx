              ...
              <div className="space-y-3 sm:space-y-4 text-center">
                <RevealAnimation delay={0.2}>
                  <h2 id="templates-heading" className="mx-auto text-center lg:max-w-[818px]">
                    Experience MerchantVerse in Action
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto text-center lg:max-w-[450px]">
                    Explore the powerful digital tools that help banks and financial institutions manage merchant onboarding, compliance, and operational performance.
                  </p>
                </RevealAnimation>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="relative z-20 mt-28 space-y-1 sm:mt-0">
                    <h3 id="card1-heading" className="text-heading-5 text-[#0d0d12]/90">
                      Merchant Lead Management
                    </h3>
                    <p className="max-w-[320px]">
                      Capture and manage merchant leads from multiple channels with centralized tracking.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-[41px] z-20 mt-8 space-y-1 sm:mt-13.5">
                    ...
                    <p className="max-w-[350px]">Digitize merchant onboarding workflows from application to activation.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative z-20 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[400px]">
                      Monitor merchant transactions, onboarding progress, and operational performance.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.2}>
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[250px]">Securely manage merchant documents, verification files, and compliance records.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    <h3 id="card5-heading" className="text-heading-5 max-w-[300px] text-[#0d0d12]/90">
                      Merchant 360° Profile
                    </h3>
                    <p className="max-w-[500px]">View merchant profiles including onboarding details, transaction history, and operational insights.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.4} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[320px]">
                      Generate analytics and reports to monitor merchant growth and performance.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
