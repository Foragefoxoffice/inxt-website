...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Digital merchant onboarding and verification',
  },
  {
    id: '2',
    text: 'Merchant compliance and regulatory checks',
  },
  {
    id: '3',
    text: 'Merchant performance and transaction monitoring',
  },
  {
    id:'4',
    text:'Merchant lifecycle and account management'
  },
  {
    id:'5',
    text:'Merchant analytics and operational reporting'
  }
];
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[620px]">
                      Applications of MerchantVerse
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>MerchantVerse enables banks and financial institutions to streamline merchant onboarding, improve compliance processes, and manage merchant networks efficiently.</p>
                  </RevealAnimation>
                </div>
