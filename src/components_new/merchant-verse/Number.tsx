          ...
          <div className="space-y-5 text-center xl:max-w-[442px] xl:text-left">
            ...
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Driving Measurable Merchant Growth</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="max-w-[780px]">
                  MerchantVerse empowers banks to accelerate merchant onboarding and gain real-time visibility into merchant performance and operations.
                </p>
              </RevealAnimation>
            </div>
          </div>
            ...
            <RevealAnimation delay={0.4} direction="up">
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Merchant Onboarding Acceleration</h3>
