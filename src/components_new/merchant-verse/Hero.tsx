            ...
            <RevealAnimation delay={0.1}>
              <h1 className="mb-3 font-medium opacity-0 leading-[1.2]">
                <span className="hero-text-gradient hero-text-color-2 block">
                  MerchantVerse <br className="hidden md:block" /> AI-Powered Merchant Onboarding & Management Platform
                </span>
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="mx-auto mb-7 max-w-[750px] md:mb-14">
                MerchantVerse is a fully digital, AI-powered platform designed to help banks and financial institutions streamline merchant onboarding and management.
                <br /><br />
                Built specifically for modern banking ecosystems, MerchantVerse automates the entire journey—from lead capture to merchant activation—while ensuring compliance, operational efficiency, and a seamless onboarding experience for merchants.
              </p>
            </RevealAnimation>
