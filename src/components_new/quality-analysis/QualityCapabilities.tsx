...
const data = [
  { id: 1, title: 'Test strategy and planning' },
  { id: 2, title: 'Automated testing frameworks' },
  { id: 3, title: 'Functional and regression testing' },
  { id: 4, title: 'Performance and load testing' },
  { id: 5, title: 'Continuous integration testing' },
  { id: 6, title: 'AI-driven test optimization' },
  { id: 7, title: 'Cloud and cross-platform testing' },
  { id: 8, title: 'Security and compliance testing' },
  { id: 9, title: 'Test data management' },
  { id: 10, title: 'Continuous quality monitoring' },
];
      ...
      <div className="main-container">
        <div className="mb-10 space-y-5 text-center md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <span className="badge bg-[#D3E7F8]">Quality Engineering Capabilities</span>
          </RevealAnimation>
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>Comprehensive Testing <br className="hidden md:block" /> & Quality Assurance</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mx-auto max-w-[500px] lg:max-w-[674px]">
                Our quality engineering services ensure software performance, reliability, and scalability through advanced testing frameworks and automation strategies.
              </p>
            </RevealAnimation>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-y-6 lg:flex-row lg:gap-8 xl:gap-12">
            <RevealAnimation delay={0.5} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">Testing Strategy & Automation</h3>
                <ul>
            ...
            <RevealAnimation delay={0.7} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">Quality Assurance & Monitoring</h3>
                <ul>
...
QualityCapabilities.displayName = 'QualityCapabilities';
export default QualityCapabilities;
