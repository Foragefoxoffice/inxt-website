          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Build a Future-Ready Digital Business
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">
                Partner with our digital transformation experts to develop innovative strategies, modernize your technology landscape, and unlock new business opportunities.
              </p>
            </RevealAnimation>
          </div>
        </div>
...
DigitalCTA.displayName = 'DigitalCTA';
