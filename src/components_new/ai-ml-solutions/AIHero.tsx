        ...
        <div className="main-container relative z-20 flex flex-col items-center justify-center text-center">
          ...
          <RevealAnimation delay={0.3}>
            <p className="mb-7 max-w-[700px] md:mb-10 lg:mb-14">
              Our AI & ML solutions help organizations unlock the power of data through intelligent automation, predictive insights, and advanced machine learning models. We design and implement AI systems that improve decision-making, optimize operations, and create smarter digital experiences.
            </p>
          </RevealAnimation>
