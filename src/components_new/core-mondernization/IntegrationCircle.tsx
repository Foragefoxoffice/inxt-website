...
const IntegrationCircle = () => {
  return (
    <svg
      ...
      <circle cx="740" cy="744" r="699.5" stroke="#E9F3FC" />
      {/* gemini - top (0°) */}
      <foreignObject x="704" y="4" width="72" height="72">
        <div className="bg-secondary border-[#D3E7F8] flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-full border-8 shadow-none">
      ...
      <foreignObject x="1378.55" y="887.947" width="72" height="72">
        <div className="bg-secondary border-[#D3E7F8] flex h-[72px] w-[72px] shrink-0 rotate-180 items-center justify-center rounded-full border-8 shadow-none">
