...
const services = [
  {
    ...
    description: 'Analyze patterns and predict trends from business data.',
    icon: 'ns-shape-33',
    image: serviceImage1,
    imageDark: serviceImageDark1,
    imgAlt: 'Machine Learning Models representation',
  },
  {
    slug: 'data-aggregation',
    title: 'Data Aggregation Engines',
    description: 'Collect and unify data from multiple enterprise systems.',
    icon: 'ns-shape-34',
    image: serviceImage2,
    imageDark: serviceImageDark2,
    imgAlt: 'Data Aggregation Engines',
  },
  {
    slug: 'nl-querying',
    title: 'Natural Language Querying',
    description: 'Allow users to interact with analytics using natural language queries.',
    icon: 'ns-shape-35',
    image: serviceImage3,
    imageDark: serviceImageDark3,
    imgAlt: 'Natural Language Querying',
  },
  {
    slug: 'real-time-processing',
    title: 'Real-Time Data Processing',
    description: 'Process and visualize data instantly across dashboards.',
    icon: 'ns-shape-36',
    image: serviceImage4,
    imageDark: serviceImageDark4,
    imgAlt: 'Real-Time Data Processing',
  },
  {
    ...
    imgAlt: 'Predictive Analytics Models',
  },
  {
    slug: 'advanced-visualization',
    title: 'Advanced Data Visualization',
    description: 'Convert complex data into clear, actionable visual insights.',
    icon: 'ns-shape-38',
    image: serviceImage3, // Reuse an image or use a new one if available
    imageDark: serviceImageDark3,
    imgAlt: 'Advanced Data Visualization',
  },
];
      ...
      <div className="main-container">
        <div className="mb-14 space-y-3 text-center md:mb-[70px]">
          ...
          <RevealAnimation delay={0.4}>
            <h2>
              Advanced AI Technologies Behind Dashes
            </h2>
          </RevealAnimation>
          <RevealAnimation delay={0.5}>
            <p className="mx-auto lg:max-w-[650px]">
              Dashes leverages advanced analytics technologies to process data, generate insights, and visualize business intelligence in real time.
            </p>
          </RevealAnimation>
        </div>
        {/* services */}
