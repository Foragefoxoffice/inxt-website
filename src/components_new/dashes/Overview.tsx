              ...
              <div className="w-full space-y-7 text-center md:text-left lg:max-w-[490px] lg:space-y-14 xl:max-w-[629px]">
                ...
                <div className="space-y-4">
                  <RevealAnimation delay={0.2}>
                    <h1>Real-Time Business Intelligence for Modern Enterprises</h1>
                  </RevealAnimation>
                  <RevealAnimation delay={0.3}>
                    <p>
                      Dashes enables organizations to visualize business performance through powerful, customizable dashboards that bring data from multiple systems into a single view.
                    </p>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
                      With advanced analytics and real-time reporting, businesses can track KPIs, identify trends, and gain deeper operational insights that support strategic decision-making.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
