          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[989px] text-center font-medium" itemProp="headline">
                Unlock Real-Time Insights for Your Business
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[789px] text-center" itemProp="description">Transform your data into actionable business intelligence with intelligent dashboards and real-time analytics.</p>
            </RevealAnimation>
          </div>
        </div>
