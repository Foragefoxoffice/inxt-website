...
const servicesData: Service[] = [
  ...
  {
    id: '2',
    text: 'Operational analytics and reporting',
  },
  {
    id: '3',
    text: 'Financial performance dashboards',
  },
  {
    id: '4',
    text: 'Customer engagement and behavior analytics',
  },
  {
    id: '5',
    text: 'Strategic planning and executive reporting',
  },
];
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[520px]">
                      Applications of Dashes
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>Dashes enables organizations to leverage real-time analytics and data visualization tools to monitor performance and improve operational decision-making.</p>
                  </RevealAnimation>
                </div>
