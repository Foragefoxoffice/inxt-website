...
const stackCards = [
  {
    ...
    description: 'Instant access to real-time business insights.',
  },
  {
    icon: 'ns-shape-35',
    title: 'Improved Performance Monitoring',
    description: 'Track KPIs and operational metrics easily.',
  },
  {
    icon: 'ns-shape-4',
    title: 'Automated Reporting',
    description: 'Reduce manual report generation.',
  },
  {
    icon: 'ns-shape-21',
    title: 'Better Strategic Planning',
    description: 'Use data insights to guide business strategies.',
  },
  {
    icon: 'ns-shape-22',
    title: 'Scalable Analytics Platform',
    description: 'Support growing data and business complexity.',
  },
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 whitespace-normal">
                Improve Data Visibility and Decision Speed
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                Dashes empowers organizations to make faster decisions by providing clear visibility into business performance through real-time analytics and automated reporting.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
