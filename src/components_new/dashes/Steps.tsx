...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect with ERP, CRM, and operational systems to centralize data.',
    image: Step1,
  },
  {
    id: '2',
    title: 'Analytics & Data Platforms',
    description: 'Integrate with data warehouses and analytics systems.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    ...
    description: 'Synchronize insights across enterprise software and digital platforms.',
    image: Step3,
  }
];
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                ...
                <RevealAnimation delay={0.2}>
                  <p>Dashes integrates with enterprise applications, operational platforms, and analytics tools to provide a unified business intelligence ecosystem.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
