...
const stepsData: Step[] = [
  {
    ...
    description: 'Connect with policy administration systems to validate claims and access policy data.',
    image: Step1,
  },
  {
    id: '2',
    title: 'Customer & Service Platforms',
    description: 'Integrate with customer engagement platforms for seamless claimant communication.',
    image: Step2,
    imageDark: Step2Dark,
  },
  {
    id: '3',
    title: 'Analytics & Fraud Detection Platforms',
    description: 'Leverage analytics tools to monitor claim patterns and detect fraud risks.',
    image: Step3,
  },
];
...
const Steps = () => {
  return (
    <section
      className="bg-background-2 dark:bg-background-5 relative py-16 md:py-20 lg:pt-[100px] xl:pt-[200px]"
            ...
            <div className="space-y-5 text-center md:space-y-8 lg:space-y-14 lg:text-left">
              <div className="space-y-1 sm:space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="mx-auto w-full sm:max-w-[629px] xl:mx-0">Connected Technology for Seamless Claims Operations</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p>ClaimVerse integrates with policy systems, customer platforms, and analytics tools to deliver a connected claims management ecosystem.</p>
                </RevealAnimation>
              </div>
            </div>
          </div>
