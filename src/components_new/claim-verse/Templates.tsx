              ...
              <div className="space-y-3 sm:space-y-4 text-center">
                <RevealAnimation delay={0.2}>
                  <h2 id="templates-heading" className="mx-auto text-center lg:max-w-[818px]">
                    Experience ClaimVerse in Action
                  </h2>
                </RevealAnimation>
                <RevealAnimation delay={0.3}>
                  <p className="mx-auto text-center lg:max-w-[450px]">
                    Explore the digital tools and dashboards that help insurers manage claims efficiently and improve operational transparency.
                  </p>
                </RevealAnimation>
              </div>
            </div>
                ...
                <div
                  ...
                  <div className="relative z-20 mt-28 space-y-1 sm:mt-0">
                    <h3 id="card1-heading" className="text-heading-5 text-[#0d0d12]/90">
                      Claim Registration Management
                    </h3>
                    <p className="max-w-[320px]">
                      Capture and manage claims through digital submission workflows.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-[41px] z-20 mt-8 space-y-1 sm:mt-13.5">
                    ...
                    <p className="max-w-[350px]">Handle claim validation, documentation checks, and approval workflows.</p>
                  </div>
                </div>
              </RevealAnimation>
                ...
                <div
                  ...
                  <div className="relative z-20 space-y-1 sm:mt-0">
                    ...
                    <p className="max-w-[400px]">
                      Monitor claim progress, operational performance, and settlement timelines.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.2}>
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[250px]">Securely store and manage claim-related documents and verification materials.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.3} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[500px]">Access complete claim details including policy data, claimant information, and history.</p>
                  </div>
                </div>
              </RevealAnimation>
              ...
              <RevealAnimation delay={0.4} start="top 100%">
                <div
                  ...
                  <div className="absolute bottom-8 left-6 z-20 space-y-1 sm:bottom-10.5 sm:left-8">
                    ...
                    <p className="max-w-[320px]">
                      Generate reports and insights to improve claims efficiency and decision-making.
                    </p>
                  </div>
                </div>
              </RevealAnimation>
