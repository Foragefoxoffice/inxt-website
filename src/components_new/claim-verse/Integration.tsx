...
const stackCards = [
  {
    ...
    description: 'Accelerated claim workflows',
  },
  {
    icon: 'ns-shape-35',
  ...
  {
    icon: 'ns-shape-21',
    title: 'Data-Driven Claims Decisions',
    description: 'Advanced claims analytics',
  },
  {
    icon: 'ns-shape-21',
    title: 'Improved Customer Satisfaction',
    description: 'Faster claim settlements',
  }
];
          ...
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            ...
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 whitespace-normal">
                Improve Claims Efficiency and Customer Trust
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                ClaimVerse helps insurers streamline claims operations while delivering faster, more transparent claims experiences for policyholders.
              </p>
            </RevealAnimation>
          </div>
          <StackCardWrapper
