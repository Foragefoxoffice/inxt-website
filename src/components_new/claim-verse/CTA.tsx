          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Transform Your <br className="hidden md:block" /> Insurance Claims Experience
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">Modernize your claims operations with an intelligent platform designed to accelerate processing, improve transparency, and enhance customer trust.</p>
            </RevealAnimation>
          </div>
        </div>
