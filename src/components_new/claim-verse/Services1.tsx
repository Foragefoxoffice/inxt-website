...
const servicesData: Service[] = [
  {
    id: '1',
    text: 'Digital claims registration and verification',
  },
  {
    id: '2',
    text: 'Claims assessment and approval workflows',
  },
  {
    id: '3',
    text: 'Fraud detection and risk analysis',
  },
  {
    id:'4',
    text:'Claims lifecycle tracking and management'
  },
  {
    id:'5',
    text:'Claims analytics and operational reporting'
  }
];
                ...
                <div className="mb-6 space-y-3 md:mb-8">
                  <RevealAnimation delay={0.1}>
                    <h2 className="xl:text-heading-2 md:text-heading-3 sm:text-heading-4 text-heading-5 md:max-w-[620px]">
                      Real-World Applications of ClaimVerse
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.2}>
                    <p>ClaimVerse enables insurers to streamline claims operations, improve fraud detection, and deliver efficient claims servicing across insurance lines.</p>
                  </RevealAnimation>
                </div>
