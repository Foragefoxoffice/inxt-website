...
const Number = () => {
  return (
    <section className="dark:bg-background-6 bg-white py-[100px] lg:pt-[50px] xl:pt-[100px]">
          ...
          <div className="space-y-5 text-center xl:max-w-[442px] xl:text-left">
            ...
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Driving Measurable Claims Performance</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="max-w-[780px]">
                  ClaimVerse helps insurers accelerate claims processing and improve operational visibility through intelligent automation and analytics.
                </p>
              </RevealAnimation>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row">
            ...
            <RevealAnimation delay={0.4} direction="up">
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Claims Processing Acceleration</h3>
            ...
            <RevealAnimation delay={0.5}>
              <div className="bg-background-2 dark:bg-background-5 flex w-full max-w-[365px] flex-1 flex-col justify-between gap-y-14 rounded-xl p-8">
                {/* card heading    */}
                <div className="flex items-center justify-between">
                  <h3 className="text-heading-5 basis-[197px]">Operational Efficiency Increase</h3>
