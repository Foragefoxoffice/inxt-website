        ...
        <div className="main-container relative z-20 flex flex-col items-center justify-center text-center">
          ...
          <RevealAnimation delay={0.2}>
            <h1 className="mx-auto my-12 max-w-[350px] leading-[1.2] sm:max-w-[450px] md:max-w-[700px] xl:max-w-[846px]">
              <span className="hero-text-gradient hero-text-color-1 block">
                Harness Oracle’s Power <br className="hidden md:block" /> with Iorta TechNXT
              </span>
            </h1>
          </RevealAnimation>
          ...
          <RevealAnimation delay={0.3}>
            <p className="mb-7 max-w-[700px] md:mb-10 lg:mb-14">
              Maximize your business potential with our expert Oracle solutions—from Database as a Service (DBaaS) to Oracle APEX development—designed to deliver scalable, secure, and high-performance enterprise systems.
            </p>
          </RevealAnimation>
...
OracleHero.displayName = 'OracleHero';
