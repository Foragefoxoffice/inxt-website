        ...
        <div className="space-y-5 text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge bg-[#D3E7F8] capitalize" aria-label="Call to action section badge" itemProp="name">
              Optimize Your Oracle Ecosystem
            </span>
          </RevealAnimation>
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 id="cta-heading" className="mx-auto max-w-[689px] text-center font-medium" itemProp="headline">
                Build Scalable Enterprise Solutions with Oracle
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[689px] text-center" itemProp="description">
                Leverage our Oracle expertise to modernize your infrastructure, optimize database performance, and develop scalable enterprise applications.
              </p>
            </RevealAnimation>
          </div>
        </div>
...
OracleCTA.displayName = 'OracleCTA';
export default OracleCTA;
