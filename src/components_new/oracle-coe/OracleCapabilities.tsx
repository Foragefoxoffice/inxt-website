...
const data = [
  { id: 1, title: 'Oracle APEX application development' },
  { id: 2, title: 'Database architecture and optimization' },
  { id: 3, title: 'Oracle cloud platform integration' },
  { id: 4, title: 'Custom enterprise application development' },
  { id: 5, title: 'Database migration and modernization' },
  { id: 6, title: 'Oracle Database administration (DBA)' },
  { id: 7, title: 'Performance monitoring and tuning' },
  { id: 8, title: 'Oracle security and compliance' },
  { id: 9, title: 'High availability and disaster recovery' },
  { id: 10, title: 'Continuous Oracle platform support' },
];
      ...
      <div className="main-container">
        <div className="mb-10 space-y-5 text-center md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <span className="badge bg-[#D3E7F8]">Oracle Capabilities</span>
          </RevealAnimation>
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>Enterprise Oracle <br className="hidden md:block" /> Solutions & Services</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mx-auto max-w-[500px] lg:max-w-[674px]">
                Our Oracle services help organizations build scalable applications, manage enterprise data, and optimize system performance through modern Oracle technologies.
              </p>
            </RevealAnimation>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-y-6 lg:flex-row lg:gap-8 xl:gap-12">
            <RevealAnimation delay={0.5} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">Oracle Development & Platforms</h3>
                <ul>
            ...
            <RevealAnimation delay={0.7} offset={70} start="top 88%">
              <div className="bg-white dark:bg-background-6 w-full max-w-[500px] space-y-6 rounded-[20px] p-8 lg:max-w-[300px] xl:max-w-[360px] xl:p-[42px]">
                <h3 className="xl:text-heading-4 text-heading-5">Oracle Infrastructure & Support</h3>
                <ul>
...
OracleCapabilities.displayName = 'OracleCapabilities';
export default OracleCapabilities;
