...
export {
  ...
  WhitePaperIcon,
  WhyChooseUsIcon,
  // Aliases for icon names used in other projects
  SupportIcon as ContactIcon,
  SuccessStoriesIcon as SuccessIcon,
  BlogIcon as ChangeLogIcon,
  AffiliateProgramIcon as AffiliateIcon,
  GlossaryIcon as ExploreResourcesIcon,
  ServiceIcon as ExploreProductIcon,
  FeatureIcon as ExplorePricingAndAccountIcon,
  AboutIcon as ExploreCompanyIcon,
  WhitePaperIcon as DocsIcon,
  FeatureIcon as PricingIcon,
  AnalyticsIcon as AnalyticsIconV2,
  CareerIcon as CareerIconV2,
  IntegrationIcon as IntegrationIconV2,
  SupportIcon as SupportIconV2,
  WhitePaperIcon as WhitePaperIconV2,
};
